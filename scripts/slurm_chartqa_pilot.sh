#!/usr/bin/env bash
#SBATCH --job-name=be-chartqa200
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=01:00:00
#SBATCH --output=/userhome/cs3/yihangc/Documents/beyond-entropy/slurm-chartqa-%j.out
...
run_dir="${repo_dir}/artifacts/gate1-chartqa-200/qwen3b-c4-seed0"
