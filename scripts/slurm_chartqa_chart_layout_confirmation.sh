#!/usr/bin/env bash
#SBATCH --job-name=be-chart-layout-confirm
#SBATCH --partition=debug
#SBATCH --gres=gpu:rtx_4090:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=01:00:00
#SBATCH --output=/userhome/cs3/yihangc/Documents/beyond-entropy/slurm-chart-layout-confirm-%j.out
...
run_dir="${repo_dir}/artifacts/confirmation-chart-layout-2137/qwen3b-chart-layout-c4-concise-seed0"
...
"${python_bin}" -m beyond_entropy collect-qwen \
  ...
  --expected-manifest-sha256 d7c96df369259c8c3645bf64c27c220936636c92e359171a50e420344c5ff0bd \
