#!/usr/bin/env bash
#SBATCH --job-name=be-chartqa-concise
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=00:30:00
#SBATCH --output=/userhome/cs3/yihangc/Documents/beyond-entropy/slurm-chartqa-concise-%j.out
...
run_dir="${repo_dir}/artifacts/gate1-chartqa-concise-sensitivity-35/qwen3b-c4-seed0"
