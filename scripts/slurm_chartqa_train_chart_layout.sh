#!/usr/bin/env bash
#SBATCH --job-name=be-train-chart-layout
#SBATCH --partition=debug
#SBATCH --gres=gpu:rtx_4090:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=03:00:00
#SBATCH --output=/userhome/cs3/yihangc/Documents/beyond-entropy/slurm-train-chart-layout-%j.out
...
run_dir="${repo_dir}/artifacts/replication-chartqa-train-4500/qwen3b-chart-layout-c4-concise-seed0"
...
"${python_bin}" -m beyond_entropy collect-qwen \
  ...
  --expected-manifest-sha256 72db6feaa4bc042e98741a48dd55421c5246c1b48c84b1fd75740d1d072ca621 \
