#!/usr/bin/env bash
#SBATCH --job-name=be-chart-layout
#SBATCH --partition=debug
#SBATCH --gres=gpu:rtx_4090:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=00:30:00
#SBATCH --output=/userhome/cs3/yihangc/Documents/beyond-entropy/slurm-chart-layout-%j.out
...
run_dir="${repo_dir}/artifacts/gate1-chartqa-200/qwen3b-chart-layout-c4-concise-seed0"
