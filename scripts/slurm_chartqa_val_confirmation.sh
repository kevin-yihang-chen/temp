#!/usr/bin/env bash
#SBATCH --job-name=be-chartqa-val1918
#SBATCH --partition=debug
#SBATCH --gres=gpu:rtx_4090:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=01:00:00
#SBATCH --output=/userhome/cs3/yihangc/Documents/beyond-entropy/slurm-chartqa-val-confirm-%j.out
...
run_dir="${repo_dir}/artifacts/confirmation-chartqa-val-1918/qwen3b-c4-concise-seed0"
...
"${python_bin}" -m beyond_entropy collect-qwen \
  ...
  --expected-manifest-sha256 d3178218853b10447228963e839716f0eac768b51bdc0f5b4a83268d3819b58b \
